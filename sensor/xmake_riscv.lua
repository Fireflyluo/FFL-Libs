...
target("sc7a20_new")
    set_kind("static")
    add_files("sc7a20_new/src/sc7a20_core.c", "sc7a20_new/src/sc7a20_sync.c", "sc7a20_new/src/sc7a20_async.c")
    add_headerfiles("sc7a20_new/inc/sc7a20.h", "sc7a20_new/inc/sc7a20_core.h", "sc7a20_new/sc7a20_reg.h")
    add_includedirs("sc7a20_new", "sc7a20_new/inc", {public = true})
    set_languages("c11")
...
target("sht40_new")
    set_kind("static")
    add_files("sht40_new/src/sht40_core.c", "sht40_new/src/sht40_sync.c", "sht40_new/src/sht40_async.c")
    add_headerfiles("sht40_new/inc/sht40.h", "sht40_new/inc/sht40_core.h")
    add_includedirs("sht40_new", "sht40_new/inc", {public = true})
    set_languages("c11")
...
target("all-sensors")
    set_kind("phony")
    add_deps("icm42688p", "qmi8658a", "sc7a20htr", "sc7a20_new", "sht40", "sht40_new", "oled")
